...
namespace mvc_core_project.Controllers
{
    public class ParentsController : Controller
    {
        ...
        public ParentsController(CollegeDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Parent parent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Parent parent)
        {
            if (id != parent.Id)
            {
                return NotFound();
